...
const CompInterCalculator = () => {
  ...
  const calculate = () => {
    ...
    const n = 1; 
    let futureValueWithInterest = principal * Math.pow(1 + interest / n, n * time);
  
    for (let i = 1; i <= time * 12; i++) {
      // Monthly contribution compounded based on remaining periods
      futureValueWithInterest += month * Math.pow(1 + interest / n, (n * time) - (i / 12));
    }
  ...
  return (
    <section className="bg-gray-200 min-h-screen flex items-center justify-center py-12">
      <div className="bg-sky-50 w-full max-w-3xl rounded-lg shadow-lg p-8 space-y-8">
        <h1 className="text-3xl font-bold text-center text-gray-800">Compound Interest Calculator</h1>
        ...
        <div className="space-y-6">
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Step 1: Initial Investment</h2>
            <label className="text-sm font-medium text-gray-600">Enter your initial investment amount</label>
            <input
              type="number"
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Step 2: Contribute</h2>
            <label className="text-sm font-medium text-gray-600">Monthly Contribution</label>
            <input
              type="number"
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Step 3: Duration</h2>
            <label className="text-sm font-medium text-gray-600">Years of Investment</label>
            <input
              type="number"
              value={years}
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Step 4: Interest Rate</h2>
            <label className="text-sm font-medium text-gray-600">Estimated Annual Interest Rate (%)</label>
            <input
              type="number"
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Step 6: Compound Frequency</h2>
            <label className="text-sm font-medium text-gray-600">Select Compound Frequency</label>
            <select
        ...
        {result && (
          <div className="mt-8 p-6 bg-green-100 rounded-lg text-center shadow-md">
            <h2 className="text-2xl font-bold text-gray-800">Your Future Value</h2>
            <p className="text-xl text-gray-700 mt-2">In {years} years, your investment will be:</p>
